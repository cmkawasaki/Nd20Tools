...
namespace Nd20TemplateLib
{
    public class EliteType : ICharacterType
    {
        ...
        public override string GetFlavorText()
        {
            ...
            EliteString += " An elite creature gains an additional attack or move action each round that can be spent performing any action other than casting a spell, using a psionic power or performing a technique.";
