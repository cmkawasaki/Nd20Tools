...
{
    class KageBunshinType : ICharacterType
    {
        public KageBunshinType()
        {
        ...
        public override int GetAverageHP(List<ClassStatEntry> MyList, int ConMod, int BonusHPFromPower)
        {
            ...
            AveHP = (int)(ClassStatEntry.GetTotalLevel(MyList) / 3);
        ...
        {
            NPCTemplate KageBunshinTemplate = new NPCTemplate("", -SourceTemplate.TemplateCR, 0, 0, 0, -4, "bunshin", -5, -2, -2, -2, 0, -SourceTemplate.MaxChakraPool, null, 0, 0, 0, "", null);
