...
namespace Nd20TemplateLib
{
    public class MinionEliteTemplates
    {
        ...
        public static XMLRace TakeRaceFromDropDown(ComboBox lComboBox)
        {
            for (int i = 0; i < RaceList.Count; i++)
            {
                if ((string)lComboBox.SelectedItem == RaceList[i].Name)
                {
                    return RaceList[i];
                }
            }
        ...
        public static void FillBunshinDropDown(ComboBox lComboBox)
        {
            ...
            lComboBox.Items.Insert(2, "Kasumi Bunshin");
            lComboBox.Items.Insert(3, "Kyouka Kage Bunshin");
            lComboBox.Items.Insert(4, "Mizu Bunshin");
            lComboBox.Items.Insert(5, "Yuki Bunshin");
            lComboBox.Items.Insert(6, "Reikibutsu");
            lComboBox.Items.Insert(7, "Human Gargantuan Unit");
        ...
        public static ICharacterType TakeBunshinTypeFromDropDown(ComboBox lComboBox)
        {
            switch (lComboBox.SelectedIndex)
            {
                ...
                case 2:
                    return new KasumiBunshinType();
                case 3:
                    return new KyoukaKageBunshinType();
                case 4:
                    return new MizuBunshinType();
                case 5:
                    return new YukiBunshinType();
                case 6:
                    return new ReikibutsuType();
                case 7:
                    return new HumanGargantuanUnitType();
                default:
                    return new NormalType();
            }
        }
