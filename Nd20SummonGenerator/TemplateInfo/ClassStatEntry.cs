...
namespace Nd20TemplateLib
{
    ...
    public class ClassStatEntry
    {
        ...
        public static string PrintClassHeaderEntries(List<ClassStatEntry> MyList, string raceName)
        {
            bool mySwitch = false;
            string returnString = "";
            ...
            if (null != MyList)
            {
                foreach (ClassStatEntry MyEntry in MyList)
                {
                    ...
                    returnString += "Level " + (MyEntry.ClassLevel / 2).ToString() + " " + MyEntry.ClassName + " " + raceName;
                    mySwitch = true;
                }
            }
