...
namespace Nd20StatblockGenerator
{
    ...
    public class XMLRace : IRace
    {
        ...
        public int ClassCR;
        public int ClassECL;
        public List<CharWeapon> RacialWeapons;
        ...
        public override NPCTemplate CreateTemplate(NPCTemplate SourceTemplate)
        {
            ...
            newTemplate.RacialFeats = RacialFeats;
            ...
            if (null != RacialWeapons)
            {
                newTemplate.RacialWeapons = RacialWeapons;
            }

            if (null != MovementTypes)
            {
                newTemplate.MovementTypes = MovementTypes;
            }
