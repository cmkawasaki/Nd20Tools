...
{
    public delegate void ChangedPrivmsgHandler(object sender, IRCMessage message);
    class genericIRCBot
    {
        private int port;
        ...
        public event ChangedPrivmsgHandler PrivmsgArrived;
        ...
        public void ConnectServer()
        {
            if (!this.isConnected)
            {
                ...
                this.inputThread = new Thread((ThreadStart)delegate()
                {
                    string line;
                    ...
                    do
                    {
                        ...
                        if (message.CommandName.ToLower() == "privmsg")
                        {
                            if (this.PrivmsgArrived != null)
                            {
                                this.PrivmsgArrived(this, message);
                            }
                        }
